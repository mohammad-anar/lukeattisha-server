...
router.post("/", fileUploadHandler(), auth(Role.ADMIN), validateRequest(CreateBlogSchema), BlogController.createBlog);
router.get("/:id", BlogController.getBlogById);
router.get("/:slug", BlogController.getBlogBySlug);
router.patch("/:id", fileUploadHandler(), auth(Role.ADMIN), validateRequest(UpdateBlogSchema), BlogController.updateBlog);
