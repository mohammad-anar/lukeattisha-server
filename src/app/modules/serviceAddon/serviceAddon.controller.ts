...
const getById = catchAsync(async (req: Request, res: Response) => {
  const result = await ServiceAddonService.getById(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: 200,
    message: 'ServiceAddon fetched successfully',
...
const update = catchAsync(async (req: Request, res: Response) => {
  const result = await ServiceAddonService.update(req.params.id as string, req.body);
  sendResponse(res, {
    success: true,
    statusCode: 200,
...
const deleteById = catchAsync(async (req: Request, res: Response) => {
  const result = await ServiceAddonService.deleteById(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: 200,
