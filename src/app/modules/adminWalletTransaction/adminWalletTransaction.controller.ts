...
const getAll = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await AdminWalletTransactionService.getAll(filters, options);
  sendResponse(res, {
    success: true,
    statusCode: 200,
...
const getById = catchAsync(async (req: Request, res: Response) => {
  const result = await AdminWalletTransactionService.getById(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: 200,
    message: 'AdminWalletTransaction fetched successfully',
...
const update = catchAsync(async (req: Request, res: Response) => {
  const result = await AdminWalletTransactionService.update(req.params.id as string, req.body);
  sendResponse(res, {
    success: true,
    statusCode: 200,
...
const deleteById = catchAsync(async (req: Request, res: Response) => {
  const result = await AdminWalletTransactionService.deleteById(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: 200,
