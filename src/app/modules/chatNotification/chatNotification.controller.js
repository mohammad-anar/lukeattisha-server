...
/* ---------- CREATE ---------- */
const createChatNotification = catchAsync(async (req, res) => {
    const result = await ChatNotificationService.createChatNotification(req.body);
    sendResponse(res, {
        success: true,
        statusCode: 201,
...
/* ---------- GET ALL ---------- */
const getAllChatNotifications = catchAsync(async (_req, res) => {
...
/* ---------- GET BY CHAT ROOM ID ---------- */
const getChatNotificationsByRoomId = catchAsync(async (req, res) => {
    const { chatRoomId } = req.params;
    const result = await ChatNotificationService.getChatNotificationsByRoomId(chatRoomId);
    sendResponse(res, {
        success: true,
        statusCode: 200,
...
/* ---------- DELETE ---------- */
const deleteChatNotification = catchAsync(async (req, res) => {
    const { id } = req.params;
