...
router.post("/", auth(Role.USER), validateRequest(CreateBookingSchema), BookingController.createBooking);
router.get("/:id", auth(Role.ADMIN, Role.USER, Role.WORKSHOP), BookingController.getBookingById);
router.get("/:id/reviews", auth(Role.ADMIN, Role.USER, Role.WORKSHOP), BookingController.getReviewByBookingId);
