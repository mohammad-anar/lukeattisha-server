...
const getAll = catchAsync(async (req: Request, res: Response) => {
  const result = await OperatorWalletTransactionService.getAll(req.query);
  sendResponse(res, {
    success: true,
    statusCode: 200,
...
const getById = catchAsync(async (req: Request, res: Response) => {
  const result = await OperatorWalletTransactionService.getById(req.params.id);
  sendResponse(res, {
    success: true,
    statusCode: 200,
    message: 'OperatorWalletTransaction fetched successfully',
...
const update = catchAsync(async (req: Request, res: Response) => {
  const result = await OperatorWalletTransactionService.update(req.params.id, req.body);
  sendResponse(res, {
    success: true,
    statusCode: 200,
...
const deleteById = catchAsync(async (req: Request, res: Response) => {
  const result = await OperatorWalletTransactionService.deleteById(req.params.id);
  sendResponse(res, {
    success: true,
    statusCode: 200,
