...
const getAll = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await CartItemService.getAll(filters, options);
  sendResponse(res, {
    success: true,
    statusCode: 200,
...
const getById = catchAsync(async (req: Request, res: Response) => {
  const result = await CartItemService.getById(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: 200,
    message: 'CartItem fetched successfully',
...
const update = catchAsync(async (req: Request, res: Response) => {
  const result = await CartItemService.update(req.params.id as string, req.body);
  sendResponse(res, {
    success: true,
    statusCode: 200,
...
const deleteById = catchAsync(async (req: Request, res: Response) => {
  const result = await CartItemService.deleteById(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: 200,
