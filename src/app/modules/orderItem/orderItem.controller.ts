...
const getById = catchAsync(async (req: Request, res: Response) => {
  const result = await OrderItemService.getById(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: 200,
    message: 'OrderItem fetched successfully',
...
const update = catchAsync(async (req: Request, res: Response) => {
  const result = await OrderItemService.update(req.params.id as string, req.body);
  sendResponse(res, {
    success: true,
    statusCode: 200,
...
const deleteById = catchAsync(async (req: Request, res: Response) => {
  const result = await OrderItemService.deleteById(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: 200,
