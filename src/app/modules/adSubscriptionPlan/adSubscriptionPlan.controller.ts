...
const getById = catchAsync(async (req: Request, res: Response) => {
  const result = await AdSubscriptionPlanService.getById(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: 200,
    message: 'AdSubscriptionPlan fetched successfully',
...
const update = catchAsync(async (req: Request, res: Response) => {
  const result = await AdSubscriptionPlanService.update(req.params.id as string, req.body);
  sendResponse(res, {
    success: true,
    statusCode: 200,
...
const deleteById = catchAsync(async (req: Request, res: Response) => {
  const result = await AdSubscriptionPlanService.deleteById(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: 200,
